...
vim.keymap.set('n', '<leader>nj', function()
	local filepath = vim.fn.system("~/Documents/MySetup/dotfiles/scripts/note_d.sh"):gsub("%s+$", "")
...
vim.keymap.set('n', '<leader>nn', ':! ~/Documents/MySetup/dotfiles/scripts/note_z.sh ', { desc = 'Create note' })
vim.keymap.set('n', '<leader>nu', ':! ~/Documents/MySetup/dotfiles/scripts/note_z.sh --tags<CR>', { desc = 'Update tags' })

vim.keymap.set('n', '<leader>nf', ':tabnew | Ex ~/Documents/MySetup/Notes/<CR>', { desc = 'Search notes' })
